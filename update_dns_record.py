...
script_loc =  get_vault_configuration('update_dns')['scrip_loc']
python_loc =  get_vault_configuration('update_dns')['python_loc']
...
def send_slack_message():
    ...
    data = {
        "text": f"update dns is done at {current_time} "
    }
